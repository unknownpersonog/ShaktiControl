  ...
  return (
    <div className="flex min-h-screen text-white relative">
      ...
      <main className={`flex-1 p-4 md:p-6 ${isMobile ? "pt-20" : ""}`}>
        ...
        <Alert
          title="Earn"
          description="Earn service coins by doing simple tasks."
          variant="default"
        />
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-0">
          <FeatureBox />
          <a
            className="border bg-gray-400 text-gray-100"
            href="https://link-hub.net/442749/unknownvps-earn"
          >
            LinkVertise Link: Donate
          </a>
        </div>
        <Footer />
      </main>
